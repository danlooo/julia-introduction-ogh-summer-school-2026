...
::: {.column width="60%"}
- Compiling saves time for code parsing and creating binaries
- Compiling takes time initially
- Compiling is very uncommon in interactive terminals
- Just-In-Time (JIT) compiler for Julia allows interactive commands
